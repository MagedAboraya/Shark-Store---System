...
container_welcome = {
    ...
    "components": [
        ...
        TD(
            "## :PNG: ─── ✦ **SHARK STORE — شـارك سـتـور** ✦ ─── :PNG:\n"
        ...
        SECTION(
            [
                "### :avj_crown: __Who are we — مـن نـحـن__ :avj_crown:",
                "نـحـن سـتـور مـتـمـيـز يـقـدم أفـضـل الـخـدمـات والـمـنـتـجـات :tag111:\n"
        ...
        TD("-# :PNG: SHARK STORE · 2026 :551465redheart:"),
    ],
}
...
container_news = {
    ...
    "components": [
        ...
        TD(
            "### :loading: ─── ✦ **Shark News — أخـبـار الـسـيـرفـر** ✦ ─── :loading:\n"
        ...
        TD(
            "### :ProBot_icon: ─── ✦ **Shark Ads — شـراء الإعـلانـات** ✦ ─── :ProBot_icon:\n"
...
container_apply = {
    ...
    "components": [
        ...
        TD(
            "### :tag111: ─── ✦ **Apply To Seller — الـتـقـديـم لـلـسـيـلـر** ✦ ─── :tag111:\n"
        ...
        TD(
            "### :avj_crown: ─── ✦ **Apply To Support — الـتـقـديـم لـلإدارة** ✦ ─── :avj_crown:\n"
        ...
        ROW(
            BTN("Apply To Seller", "shark_apply_team", 1),
...
container_rules = {
    ...
    "components": [
        ...
        TD(
            "### :PNG: ─── ✦ **Shark Rules — قـوانـيـن شـارك سـتـور** ✦ ─── :PNG:\n"
        ...
        TD("-# ✦ :PNG: SHARK STORE © 2026 • جـمـيـع الـحـقـوق مـحـفـوظـة :551465redheart: ✦"),
    ],
}
